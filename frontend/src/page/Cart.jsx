        ...
        <div className='border-t pt-14'>    
            ...
            <div>
                {cartData.map((item, index) => {
                    ...
                    return (
                        <div key={index} className='py-4 border-y text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid[4fr_2fr_0.5fr] items-center gap-4'>
                            <div className='flex items-start gap-6'>
                                <img src={productData.image[0]} alt="" className='w-16 sm:w-20'/>
                                <div className=''>
                                    <p className='text-xs sm:text-lg font-medium'>{productData.name}</p>
                                    <div className='flex items-center gap-5 mt-2'>
                                        <p>{productData.price.toLocaleString('de-DE')}
                ...
                <div className='flex justify-end my-20'>
                    <div className='w-full sm:w-[450px]'>
                        ...
                        <div className='w-full text-end'>
                            <button onClick={() => navigate('/place-order')} className=' bg-black text-white text-sm px-8 py-3 my-8'>
