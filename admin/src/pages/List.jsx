    ...
    return (
        <div>
            ...
            <div className='flex flex-col gap-2'>
                {/* List table title */}
                <div className='grid grid-cols-[1fr_2fr_1fr_0.5fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-1 px-2 border bg-gray-100 text-sm'>
                    <b>Image</b>
                    <b>Name</b>
                ...
                {/* Product List */}
                {list.map((item, index) => (
                    <div key={index} className='grid grid-cols-[1fr_2fr_1fr_0.5fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center gap-2 py-1 px-2 border text-sm'>
